...
windowSpec = Window.orderBy("date_ingested").rowsBetween(Window.unboundedPreceding, Window.currentRow)
...
df_price_metrics = df_price_metrics.withColumn("price_per_land_size", col("price") / col("land_size"))


df_price_metrics = df_price_metrics.withColumn("price_per_bldg_size", col("price") / col("building_size"))
